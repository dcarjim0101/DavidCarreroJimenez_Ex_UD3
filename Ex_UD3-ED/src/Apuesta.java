...
public class Apuesta extends javax.swing.JFrame {
    ...
    /**
     * 
     * @param evt Este método define la variable de agregarpartido y utiliza un constructor
     */
    ...
    /**
     * 
     * @param evt selecciona una quiniela de la variable borrarPartido
     */
   ...
   /**
    * 
    * @param n1 es la primera variable que recibe
    * @param n2 es la segunda variable que recibe
    * @return devuelve la operacion de un numero entero aleatorio multiplicado por n2 - n1 + 1 y sumado a n1
    */
    ...
    /**
     * 
     * @param evt crea una opcion de quiniela dependiendo del resultado de un partido
     */
    ...
    /**
     * 
     * @param partido es una variable que recibe el metodo para hacer la quiniela de un partido
     */
    ...
    /**
     * 
     * @param indice recibe el indice de un partido y evalúa si cumple con la condición o no
     */
    ...
    /**
     * 
     * @param args es el metodo principal del programa
     */
